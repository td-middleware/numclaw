...
async function setupTokenHandler(root) {
  ...
  const { ConsoleOAuthFlow } = await import("./chunk-4k1ctrxm.js");
...
var DoctorLazy = import_react.default.lazy(() => import("./chunk-0njgfr0p.js").then((m) => ({ default: m.Doctor })));
...
async function installHandler(target, options) {
  ...
  const { install } = await import("./chunk-3t4swhda.js");
  await new Promise((resolve) => {
    const args = [];
    if (target)
      args.push(target);
