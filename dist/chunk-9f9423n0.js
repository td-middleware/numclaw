...
async function createBridgeSession({
  ...
  const { getClaudeAIOAuthTokens } = await import("./chunk-594k3mft.js");
  const { getOrganizationUUID } = await import("./chunk-wsm87h0m.js");
  const { getOauthConfig } = await import("./chunk-m2bcpk8j.js");
  const { getOAuthHeaders } = await import("./chunk-jcg37spj.js");
  const { parseGitHubRepository } = await import("./chunk-mdk3xgya.js");
  const { getDefaultBranch } = await import("./chunk-1vthytca.js");
  const { getMainLoopModel } = await import("./chunk-3adhky3b.js");
