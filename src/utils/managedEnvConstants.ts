...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'LOCAL_BASE_URL',
  'LOCAL_MODEL',
  'LOCAL_DEFAULT_HAIKU_MODEL',
  'LOCAL_DEFAULT_HAIKU_MODEL_DESCRIPTION',
  'LOCAL_DEFAULT_HAIKU_MODEL_NAME',
  'LOCAL_DEFAULT_HAIKU_MODEL_SUPPORTED_CAPABILITIES',
  'LOCAL_DEFAULT_OPUS_MODEL',
  'LOCAL_DEFAULT_OPUS_MODEL_DESCRIPTION',
  'LOCAL_DEFAULT_OPUS_MODEL_NAME',
  'LOCAL_DEFAULT_OPUS_MODEL_SUPPORTED_CAPABILITIES',
  'LOCAL_DEFAULT_SONNET_MODEL',
  'LOCAL_DEFAULT_SONNET_MODEL_DESCRIPTION',
  'LOCAL_DEFAULT_SONNET_MODEL_NAME',
  'LOCAL_DEFAULT_SONNET_MODEL_SUPPORTED_CAPABILITIES',
  'LOCAL_SMALL_FAST_MODEL',
